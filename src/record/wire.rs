...
pub fn network_role_name(role: NetworkRole) -> &'static str {
    match role {
        ...
        NetworkRole::DomainController => "domain-controller",
...
pub fn network_role(name: &str) -> Option<NetworkRole> {
    Some(match name {
        ...
        "domain-controller" => NetworkRole::DomainController,
...
pub fn status_protocol_name(protocol: &StatusProtocol) -> Cow<'_, str> {
    match protocol {
        ...
        StatusProtocol::TcpConnect => Cow::Borrowed("tcp_connect"),
...
pub fn status_protocol(name: &str) -> Option<StatusProtocol> {
    ...
    Some(match name {
        ...
        "tcp_connect" => StatusProtocol::TcpConnect,
...
pub fn scan_response_name(response: &ScanResponse) -> Cow<'_, str> {
    match response {
        ...
        ScanResponse::ConnectionRefused => Cow::Borrowed("connection_refused"),
...
pub fn scan_response(name: &str) -> Option<ScanResponse> {
    ...
    Some(match name {
        ...
        "connection_refused" => ScanResponse::ConnectionRefused,
...
pub fn scanner_kind_name(kind: ScannerKind) -> &'static str {
    match kind {
        ...
        ScannerKind::RoutedSctp => "routed_sctp",
...
pub fn scanner_kind(name: &str) -> Option<ScannerKind> {
    Some(match name {
        ...
        "routed_sctp" => ScannerKind::RoutedSctp,
