...
/// [`ScanReport`](crate::core::report::ScanReport), describing however far it
...
/// report's [`StopReason`](crate::core::report::StopReason) says
/// `Aborted` so nobody mistakes a shortened scan for a complete one.
///
/// Cloneable and shareable: the copy on a [`ScanSession`](crate::core::session::ScanSession)
