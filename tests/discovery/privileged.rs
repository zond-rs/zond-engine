...
#[cfg(target_os = "linux")]
use zond_engine::utils::NetnsContext;
...
async fn privileged_discovery_hostname_resolution() {
    ...
    let _ = zond_engine::utils::netns::run_ns_cmd(&ctx.ns_name, "hostname", &["zond-target-host"]);
    ...
    std::thread::spawn(move || {
        let _ = zond_engine::utils::netns::run_ns_cmd(
            &ns_name,
            "nc",
